...
namespace GameStrings
{
	...
	GAMEMD_STRING(THEMEMD_MIX, 0x81C24Cu);
	GAMEMD_STRING(MOUSE_SHA, 0x82604Cu);
	GAMEMD_STRING(KEYBOARDMD_INI, 0x827B88u);
	GAMEMD_STRING(PROFILERAMDDMB, 0x827F34u);
	GAMEMD_STRING(RAMREPORTEDDMB, 0x827F20u);
	GAMEMD_STRING(CPUDMHZS, 0x827F4Cu);
	GAMEMD_STRING(PROFILECPUDDMH, 0x827F5Cu);
	GAMEMD_STRING(PROFILEVRAMSPE, 0x827EBCu);
	GAMEMD_STRING(VRAMREPORTEDDM, 0x827F04u);

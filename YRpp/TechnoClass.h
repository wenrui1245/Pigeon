...
public:
	...
	PassengePhoboslass() : NumPassengers(0), FirstPassenger(nullptr) {};
...
public:
	...
	virtual bool TriggePhobosellInset(AbstractClass *pTarget) R0;
...
public:
	...
	DECLARE_PROPERTY(PassengePhoboslass, Passengers);
